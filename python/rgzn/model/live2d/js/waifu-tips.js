...
function loadWidget(config) {
  ...
  (function live2dMove() {
    // 1.获取元素
    var oBox = document.getElementById("waifu");
    var toolBox = document.getElementById("waifu-tool");

    // 2.鼠标按下事件
    oBox.addEventListener("mousedown", (ev) => {
    ...
    toolBox.addEventListener("mousedown", (e) => {
      ...
      window.onmousemove = function (e) {
        ...
        toolBox.style.top = y3 - y2 + "px";
        toolBox.style.left = x3 - x2 + "px";
